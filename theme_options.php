...
// -> START Basic Fields
    ...
    'desc' => "<div class='redux-info-field'><h3>".__('Welcome to Pinnacle Theme Options', 'pinnacle')."</h3>
                                    ...
                                    <br />
                                    ".__('For support please visit', 'pinnacle').": <a href=\"https://kadencethemes.com/support/\" target=\"_blank\">kadencethemes.com/support/</a></p></div>",
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array('none' => __('None', 'pinnacle'),'pagetitle' => __('Page Title', 'pinnacle'),'flex' => __('Flex Slider', 'pinnacle'),'carousel' => __('Carousel Slider', 'pinnacle'),'imgcarousel' => __('Image Carousel', 'pinnacle'),'rev' => __('Revolution Slider', 'pinnacle'),'cyclone' => __('Shortcode Entry', 'pinnacle'),'ksp' => __('Kadence Slider Pro', 'pinnacle'),'ktslider' => __('Kadence Slider Legacy', 'pinnacle'),'latest' => __('Latest Posts', 'pinnacle'), 'video' => __('Video', 'pinnacle')),
            'default' => 'pagetitle',
            'width' => 'width:60%',
            ),
        array(
    ...
    'fields' => array(
      ...
      array(
        ...
        array(
            ...
            'options' => array('none' => __('None', 'pinnacle'),'flex' => __('Flex Slider', 'pinnacle'), 'carousel' => __('Carousel Slider', 'pinnacle'), 'rev' => __('Revolution Slider', 'pinnacle'),'ksp' => __('Kadence Slider Pro', 'pinnacle'),'ktslider' => __('Kadence Slider Legacy', 'pinnacle'), 'shortcode' => __('Shortcode Slider', 'pinnacle'),'pagetitle' => __('Page Title', 'pinnacle'), 'video' => __('Video', 'pinnacle')),
            'default' => 'none',
            'width' => 'width:60%',
            'required' => array('mobile_switch','=','1'),
            ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
       ...
       array(
		...
		/*Customizing AGY 03.01.17 - multi- BEGIN*/
         array(
            'id'=>'home_post_type',
            'type' => 'select',
			'multi' => true,
            ...
            'subtitle' => __('Leer lassen um alle anzuzeigen.', 'pinnacle'),
            'width' => 'width:60%',
            ),
			/*Customizing AGY 03.01.17 END*/
         array(
    ...
    'fields' => array(
      ...
      array(
        ...
        array(
            ...
            'options' => array('square' => __('Square 1:1', 'pinnacle'), 'portrait' => __('Portrait 3:4', 'pinnacle'), 'landscape' => __('Landscape 4:3', 'pinnacle'), 'widelandscape' => __('Wide Landscape 4:2', 'pinnacle'), 'off' => __('Turn Off', 'pinnacle')),
            'default' => 'square',
            'width' => 'width:60%',
            ),
        array(
      ...
      array(
        ...
        array(
            ...
            'options' => array('pagetitle' => __('Page Title', 'pinnacle'),'rev' => __('Revolution Slider', 'pinnacle'),'ksp' => __('Kadence Slider Pro', 'pinnacle'), 'ktslider' => __('Kadence Slider Legacy', 'pinnacle'), 'cyclone' => __('Shortcode Entry', 'pinnacle'),'flex' => __('Flex Slider', 'pinnacle'), 'carousel' => __('Carousel Slider', 'pinnacle'), 'none' => __('None', 'pinnacle')),
            'default' => 'pagetitle',
            'width' => 'width:60%',
            ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('This sets the defualt caption setting to true.', 'pinnacle'),
            "default" => 0,
            ),
        array(
